...
const FirstBanner = () => {
  return (
    <div className="md:container mx-auto px-4">
      <motion.div
        className="w-full bg-[#89F2F6] rounded-2xl"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-6 p-6">
          ...
          >
            ...
            <button className="mt-3 px-5 py-2 bg-white text-black rounded-full font-medium hover:scale-105 transition">
              Shop Now
            </button>
          </motion.div>
        </div>
